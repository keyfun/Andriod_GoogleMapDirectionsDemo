...
public class MainActivity extends FragmentActivity {
	...
	static final String LANGUAGE_TC = "zh-HK";
	static final String LANGUAGE_SC = "zh-CN";
	...
	private String getDirectionsUrl(LatLng origin, LatLng dest) {
		...
		String departure_time = "departure_time=" + unixTime; 
		
		String language = "language=" + LANGUAGE_EN;
		
		// Building the parameters to the web service
		String parameters = str_origin + "&" + str_dest + "&" + sensor 
				+ "&" + mode + "&" + language + "&" + departure_time;
	...
	private class ParserTask extends
		...
		protected void onPostExecute(List<DirectionsData> result) {
			...
			for (int i = 0; i < result.size(); i++) {
				...
				// Fetching i-th route
				List<HashMap<String, String>> path = result.get(i).path;
				List<String> html_instructions = result.get(i).html_instructions;
				
				for(int k = 0; k < html_instructions.size(); k++) {
					Log.i(TAG, k + "-->" + html_instructions.get(k));
				}
